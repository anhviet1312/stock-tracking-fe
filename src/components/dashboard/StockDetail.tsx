...
import { X, TrendingUp, TrendingDown, Globe, BarChart2, BellRing } from 'lucide-react';
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                {isAuthenticated && (
                  <button 
                    ...
                    className="ml-2 p-1.5 bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-500/20 rounded-lg text-indigo-400 transition-colors flex items-center gap-1 text-xs font-medium"
                    title="Setup Price Alert"
                  >
          ...
          <div className="p-6 md:p-8 overflow-y-auto">
            <CandlestickChart symbol={stock.stockSymbol} />
      ...
      {showAlertModal && (
        <AlertSetupModal 
          ...
          currentPrice={stock.matchedPrice} 
